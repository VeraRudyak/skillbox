...
import main.java.ParserMoscowMetro.ParserMoscowMetro;
...
public class Main {
    private static final String dataFile = "C:/skillbox/java_basics/MSCMetro/MoscowMetro/src/main/resources/metro.json";

    private static StationIndex stationIndex;

    public static void main(String[] args) throws IOException {

        ParserMoscowMetro metroInfo = new ParserMoscowMetro();
