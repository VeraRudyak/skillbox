...
public class ParserMoscowMetro {
    public void downloadInfoJson() throws IOException {
        ...
        BufferedWriter writer = Files.newBufferedWriter
                (Paths.get("C:/skillbox/java_basics/MSCMetro/MoscowMetro/src/main/resources/metro.json"));
    ...
    private static JSONArray getArrayLine(Elements lineElements) {
        ...
        for (Element elementLine : lineElements) {
            ...
            lines1.put("number", numberLine);
            lines1.put("name", nameLine);
            lines.add(lines1);
        }
        return lines;
    }
    ...
    private static JSONArray getArrayConnections(Elements connectionsElements) {
        ...
        for (Element element : connectionsElements) {
            ...
            Elements cElements1 = element.select("p:has(span.t-icon-metroln)");
            for (Element element1 : cElements1) {
                ...
                Elements cElements2 = element1.select("p:has(span.t-icon-metroln) > span.t-icon-metroln");
